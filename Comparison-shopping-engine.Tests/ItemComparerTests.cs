...
namespace Comparison_shopping_engine.Tests
{
    ...
    public class ItemComparerTests
    {
        ...
        {
            Item a = new Item("Name", "StoreA", 9.99, "2017-10-05");
            Item b = new Item("Name", "StoreB", 19.99, "2017-10-06");
        ...
        {
            Item a = new Item("NameA", "Store", 9.99, "2017-10-05");
            Item b = new Item("NameB", "Store", 19.99, "2017-10-06");
        ...
        public void IsEqualTest()
        {
            ...
            Item b = new Item("Name", "Store", 9.99, "2017-10-05");
        ...
        {
            Item a = new Item("Name", "Store", 19.99, "2017-10-01");
            Item b = new Item("Name", "Store", 9.99, "2017-10-05");
        ...
        {
            Item a = new Item("Name", "Store", 19.99, "2017-10-05");
            Item b = new Item("Name", "Store", 9.99, "2017-10-01");
        ...
        {
            Item a = new Item("Name", "StoreA", 5.99, "2017-10-05");
            Item b = new Item("Name", "StoreB", 9.99, "2017-10-01");
        ...
        {
            Item a = new Item("NameA", "StoreA", 5.99, "2017-10-06");
            Item b = new Item("NameB", "StoreB", 7.00, "2014-12-12");
