...
mono --debug --profile=monocov:outfile=monocovCoverage.cov,+Comparison-shopping-engine-backend ../packages/NUnit.ConsoleRunner.3.7.0/tools/nunit3-console.exe --process=Single ../Comparison-shopping-engine-backend.Tests/bin/Release/Comparison-shopping-engine-backend.Tests.dll
